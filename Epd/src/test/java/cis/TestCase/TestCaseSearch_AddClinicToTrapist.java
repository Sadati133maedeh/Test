...
public class TestCaseSearch_AddClinicToTrapist {
      String nationalCode;
  ...
  public void f(String URL ,String UserName ,String Password) throws Throwable {
	 ...
	 PageObgect_AddClinicToTrapist searchTrapist = PageFactory.initElements(driver, PageObgect_AddClinicToTrapist.class);
