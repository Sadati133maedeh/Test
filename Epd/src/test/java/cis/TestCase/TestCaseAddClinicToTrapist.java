...
public class TestCaseAddClinicToTrapist {
      String nationalCode;
  ...
  public void f(String URL ,String UserName ,String Password) throws Throwable {
	  ...
	  Thread.sleep(500);
	  menu.system_variable_add_clinic_trapist(driver);
	  Thread.sleep(3000);
	 for(String window : driver.getWindowHandles() ) {
	  driver.switchTo().window(window);
	  }
	   //AddClinicToTrapist
	 PageObgect_AddClinicToTrapist addClinicToTrapist = PageFactory.initElements(driver, PageObgect_AddClinicToTrapist.class);
	 addClinicToTrapist.AddClinicToTrapist(driver);
	   }
