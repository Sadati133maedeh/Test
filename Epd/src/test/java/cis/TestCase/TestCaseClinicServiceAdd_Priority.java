...
public class TestCaseClinicServiceAdd_Priority {
      String nationalCode;
  ...
  public void f(String URL ,String UserName ,String Password) throws Throwable {
	 ...
	 PageObgect_AddClinicService priority = PageFactory.initElements(driver, PageObgect_AddClinicService.class);
	 priority.AddServicToClinic(driver);
	  Thread.sleep(2000);
