	  ...
	  WebElement DrugFranshizShare;
		  ...
		  .click(OpenYear).perform();
		  		   Thread.sleep(1000);
		  		    ...
		  		    WebElement ChoosePeresentYear= driver.findElement(By.xpath("//tbody/tr[3]/td[2]"));
		   action
		  .click(ChoosePeresentYear).perform();
		  		   Thread.sleep(1000);

	    
	    		      WebElement ChooseMonth= driver.findElement(By.xpath("//tbody/tr[2]/td[2]"));
		  ...
		  .click(ChooseMonth).perform();
		  		   Thread.sleep(1000);
		  	    	  ...
		  	    	  WebElement ChooseDay= driver.findElement(By.xpath("//tbody/tr[3]/td[2]"));
          ...
          WebElement EditButton=driver.findElement(By.xpath("//button[text()='æíÑÇíÔ']"));
              ...
              Assert.assertTrue(alert.contains("ãæÝÞíÊ"));
