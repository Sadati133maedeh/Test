...
public class TestCase_AddFixPriceRepetitious {
      WebDriver driver;
      
      
  @Test(dataProvider="AddFixPriceRepetitious",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String mainGroup,String herfeyi ,String fani,String fulltime,String tariff,String contract) throws Throwable {
	  ...
	  //Add fix price Repetitious
	  PageObject_riali_fixed AddFixPriceRepetitious=PageFactory.initElements(driver, PageObject_riali_fixed.class);
	  AddFixPriceRepetitious.AddFixPriceRepetitious(driver, mainGroup, herfeyi, fani, fulltime, tariff, contract);
	  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);  
