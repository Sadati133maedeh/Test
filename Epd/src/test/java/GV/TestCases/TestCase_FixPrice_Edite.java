...
public class TestCase_FixPrice_Edite {
      WebDriver driver;
      
      
  @Test(dataProvider="EditFixPrice",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String mainGroup,String herfeyi ,String fani,String fulltime,String tariff,String contract) throws Throwable {
	  ...
	  //Edit fix price 
	  PageObject_riali_fixed EditFixPrice=PageFactory.initElements(driver, PageObject_riali_fixed.class);
	  EditFixPrice.EditFixPrice(driver, mainGroup, herfeyi, fani, fulltime, tariff, contract);
	  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);  
