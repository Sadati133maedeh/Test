...
public class TestCase_EditeTariffK {
      WebDriver driver;
      
      
  @Test(dataProvider="EditTarrifK",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String Newtariff, String tariff) throws Throwable {
	  ...
	  //Edite k
	  PageObject_riali_K_tariff EditeK=PageFactory.initElements(driver, PageObject_riali_K_tariff.class);
	  EditeK.Edit_Tariff_k(driver, Newtariff, tariff);
	  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);  
