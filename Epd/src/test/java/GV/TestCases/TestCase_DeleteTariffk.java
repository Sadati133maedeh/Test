...
public class TestCase_DeleteTariffk {
      WebDriver driver;
      
      
  @Test(dataProvider="EditTarrifK",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password, String tariff,String contract) throws Throwable {
	  ...
	  //Delete k
	  PageObject_riali_K_tariff DeleteK=PageFactory.initElements(driver, PageObject_riali_K_tariff.class);
	  DeleteK.Delete_Tariff_k(driver, tariff, contract);
	  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);  
