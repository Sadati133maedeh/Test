...
public class TestCase_AddFixPrice {
      WebDriver driver;
      
      
  @Test(dataProvider="AddFixPrice",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String mainGroup,String herfeyi ,String fani,String fulltime,String herfeyi2 ,String fani2,String fulltime2,String tariff,String contract,String tariff2,String contract2) throws Throwable {
	  ...
	  //Add fix price 
	  PageObject_riali_fixed AddFixPrice=PageFactory.initElements(driver, PageObject_riali_fixed.class);
	  AddFixPrice.AddFixPrice(driver, mainGroup, herfeyi, fani, fulltime, herfeyi2, fani2, fulltime2, tariff, contract, tariff2, contract2);
	  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);  
