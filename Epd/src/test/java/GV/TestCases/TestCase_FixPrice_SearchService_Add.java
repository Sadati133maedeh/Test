...
public class TestCase_FixPrice_SearchService_Add {
      WebDriver driver;
      
      
  @Test(dataProvider="SearchService_Add",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String mainGroup) throws Throwable {
	  ...
	  //SearchService_Add fix price 
	  PageObject_riali_fixed SearchService_Add=PageFactory.initElements(driver, PageObject_riali_fixed.class);
	  SearchService_Add.SearchService_Add(driver, mainGroup);
	  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);  
