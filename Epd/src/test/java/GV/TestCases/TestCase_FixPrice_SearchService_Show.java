...
public class TestCase_FixPrice_SearchService_Show {
      WebDriver driver;
      
      
  @Test(dataProvider="SearchService_Show",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String mainGroup, String serviceName) throws Throwable {
	  ...
	  //SearchService_Show fix price 
	  PageObject_riali_fixed SearchService_Show=PageFactory.initElements(driver, PageObject_riali_fixed.class);
	  SearchService_Show.SearchService_Show(driver, mainGroup, serviceName);
	  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);  
