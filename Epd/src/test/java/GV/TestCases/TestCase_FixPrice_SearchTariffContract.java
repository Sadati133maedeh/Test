...
public class TestCase_FixPrice_SearchTariffContract {
      WebDriver driver;
      
      
  @Test(dataProvider="SearchTariffContract",dataProviderClass=DataProviders.class)
  public void f(String URL ,String UserName ,String Password,String mainGroup ,String tariff, String contract) throws Throwable {
	  ...
	  //SearchTariffContract fix price 
	  PageObject_riali_fixed SearchTariffContract=PageFactory.initElements(driver, PageObject_riali_fixed.class);
	  SearchTariffContract.SearchTariffContract(driver, mainGroup, tariff, contract);
	  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);  
